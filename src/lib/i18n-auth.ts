...
export const authEn: Record<string, string> = {
  ...
  "auth.clubHint": "Register as an owner: your account is created instantly, the club goes live after moderation.",
...
export const authRu: Record<string, string> = {
  ...
  "auth.clubHint": "Регистрируетесь как владелец: аккаунт создаётся сразу, клуб публикуется после модерации.",
...
export const authKk: Record<string, string> = {
  ...
  "auth.clubHint": "Иесі ретінде тіркелесіз: аккаунт бірден құрылады, клуб модерациядан кейін жарияланады.",
